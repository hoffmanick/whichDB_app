...
import { default as __DTS_1__ } from 'ol/renderer/canvas/TileLayer';
import { DefineComponent, ComponentOptionsMixin, PublicProps, ExtractPropTypes, PropType, type Ref } from 'vue';
...
declare const _default: __VLS_WithTemplateSlots<DefineComponent<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<LayersCommonProps & {
    ...
    tileLayer: Ref<{
        createRenderer: () => __DTS_1__<TileLayer<Tile>>;
        ...
        getRenderer: () => __DTS_1__<TileLayer<Tile> | VectorTile> | null;
        hasRenderer: () => boolean;
        getBackground: () => false | BackgroundColor;
        getClassName: () => string;
        getLayerState: (managed?: boolean | undefined) => State;
        getLayersArray: (array?: Layer<Source, __DTS_2__<any>>[] | undefined) => Layer<Source, __DTS_2__<any>>[];
